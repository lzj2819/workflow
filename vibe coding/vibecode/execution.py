...
def admit_coding(
    ...
    if leaf_gate.get("admission_state") != "ADMITTED":
        raise AdmissionError("Leaf Gate admission is not ADMITTED")
    if leaf_gate.get("bundle_verified") is not True:
        raise AdmissionError("Leaf Gate bundle manifest is not verified")
