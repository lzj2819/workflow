---
doc_id: UNKNOWN-MOD-02-v1.0-SI-XFER-v1.0
version: 1.0.0
layer: derive
...
status: complete
priority: P0
created_at: '2026-07-19T17:47:54.667162'
interface_refs: []
dependency_refs:
- SI-CORE
- SI-API
...
requirement_id_mapping:
  REQ-D001: REQ-DD001
  REQ-D002: REQ-DD002
run_id: run_sess_94788a68
project_id: UNKNOWN-MOD-02-v1.0-SI-XFER-v1.0
node_id: root
parent_node_id: null
artifact_id: prd:UNKNOWN-MOD-02-v1.0-SI-XFER-v1.0:root:run_sess_94788a68
artifact_type: prd
...
## 痛点描述
上层节点中与 SI-XFER 相关的行为需要被收窄到该模块边界内：functional

## 机会窗口
由 SI-XFER 只承接自身拥有的行为（对话/代码/截图/结果文件的分片接收、合并与可恢复上传），避免把父层复杂度平移到子 PRD。
...
- evidence_refs: D-003 | D-004 | D-005 | D-011 | parent_acceptance_contract:AC-REQ-003-01 | contract_projection:MOD-02:shared | parent_acceptance_contract:D-AC-REQ-003-01 | contract_projection:SI-XFER:shared
