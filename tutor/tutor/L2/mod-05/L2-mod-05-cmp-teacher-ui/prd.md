---
doc_id: UNKNOWN-MOD-05-v1.0-CMP-TEACHER-UI-v1.0
version: 1.0.0
layer: derive
parent_doc: UNKNOWN-MOD-05-v1.0
parent_arch: architecture
module_name: CMP-TEACHER-UI
author: Claude
status: complete
priority: P0
created_at: '2026-07-19T17:47:58.943689'
interface_refs: []
dependency_refs:
- CMP-REVIEW-COMMAND
- CMP-REVIEW-QUERY
...
requirement_id_mapping:
  REQ-D001: REQ-DD001
  REQ-D002: REQ-DD002
run_id: run_sess_c07238f0
project_id: UNKNOWN-MOD-05-v1.0-CMP-TEACHER-UI-v1.0
node_id: root
parent_node_id: null
artifact_id: prd:UNKNOWN-MOD-05-v1.0-CMP-TEACHER-UI-v1.0:root:run_sess_c07238f0
artifact_type: prd
...
## 痛点描述
上层节点中与 CMP-TEACHER-UI 相关的行为需要被收窄到该模块边界内：functional

## 机会窗口
由 CMP-TEACHER-UI 只承接自身拥有的行为（教师网页中的查询、批注、展示视图和删除确认可观察面），避免把父层复杂度平移到子 PRD。
