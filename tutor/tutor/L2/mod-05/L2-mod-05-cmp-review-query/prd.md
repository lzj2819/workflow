---
doc_id: UNKNOWN-MOD-05-v1.0-CMP-REVIEW-QUERY-v1.0
version: 1.0.0
layer: derive
parent_doc: UNKNOWN-MOD-05-v1.0
parent_arch: architecture
module_name: CMP-REVIEW-QUERY
author: Claude
status: complete
priority: P0
created_at: '2026-07-19T17:47:58.511132'
interface_refs: []
dependency_refs:
- CMP-REVIEW-COMMAND
- CMP-TEACHER-UI
...
requirement_id_mapping:
  REQ-D001: REQ-DD001
run_id: run_sess_2240aafc
project_id: UNKNOWN-MOD-05-v1.0-CMP-REVIEW-QUERY-v1.0
node_id: root
parent_node_id: null
artifact_id: prd:UNKNOWN-MOD-05-v1.0-CMP-REVIEW-QUERY-v1.0:root:run_sess_2240aafc
artifact_type: prd
...
## 痛点描述
上层节点中与 CMP-REVIEW-QUERY 相关的行为需要被收窄到该模块边界内：functional

## 机会窗口
由 CMP-REVIEW-QUERY 只承接自身拥有的行为（教师课程/小组/学生/提交详情查询与失败结果装配），避免把父层复杂度平移到子 PRD。
