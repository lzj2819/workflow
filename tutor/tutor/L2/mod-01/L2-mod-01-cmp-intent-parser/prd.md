---
doc_id: UNKNOWN-MOD-01-v1.0-CMP-INTENT-PARSER-v1.0
version: 1.0.0
layer: derive
parent_doc: UNKNOWN-MOD-01-v1.0
parent_arch: architecture
module_name: CMP-INTENT-PARSER
author: Claude
status: complete
priority: P0
created_at: '2026-07-19T17:47:51.953573'
interface_refs: []
dependency_refs:
- CMP-PENDING-QUEUE
...
requirement_id_mapping:
  REQ-D001: REQ-DD001
run_id: run_sess_7078591a
project_id: UNKNOWN-MOD-01-v1.0-CMP-INTENT-PARSER-v1.0
node_id: root
parent_node_id: null
artifact_id: prd:UNKNOWN-MOD-01-v1.0-CMP-INTENT-PARSER-v1.0:root:run_sess_7078591a
artifact_type: prd
...
## 痛点描述
上层节点中与 CMP-INTENT-PARSER 相关的行为需要被收窄到该模块边界内：functional

## 机会窗口
由 CMP-INTENT-PARSER 只承接自身拥有的行为（解析自然语言提交指令 → SubmissionIntent；确定性缺项检测并返回具体缺失字段），避免把父层复杂度平移到子 PRD。
