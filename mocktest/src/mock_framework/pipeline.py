"""LEGACY Pipeline retained only for shadow-equivalence migration.

It must not publish Mocktest v2 status or artifacts.  The public CLI and Codex
Skill use the canonical contract instead.
"""
