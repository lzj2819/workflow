"""LEGACY Skill wrapper retained only for shadow-equivalence migration.

The canonical workflow is governed by `.agents/skills/validate-arch/SKILL.md`.
This wrapper must not define public Mocktest v2 output status.
"""
